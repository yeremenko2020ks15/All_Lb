...
class DoctorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doctor" do
    assert_difference('Doctor.count') do
      post doctors_url, params: { doctor: { name: @doctor.name, specialization: @doctor.specialization } }
    end
  ...
  test "should update doctor" do
    patch doctor_url(@doctor), params: { doctor: { name: @doctor.name, specialization: @doctor.specialization } }
